  ...
  Future<void> _entrar() async {
    ...
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => DashboardContratanteTela(api: _api)),
      );
    } catch (e) {
      if (!mounted) return;
                ...
                children: [
                  Expanded(
                    child: PainelAuthLateral(
                      variante: MinutaskVariante.contratante,
                      titulo: 'Contrate ajuda\n',
                      subtitulo: 'na hora',
                      beneficios: const [
                        'Publique qualquer tipo de serviço',
                        'Trabalhadores recebem em tempo real',
                        'Aceite estilo Uber — rápido e simples',
                        'Pague o valor que você combinar',
                      ],
                    ),
                  ),
