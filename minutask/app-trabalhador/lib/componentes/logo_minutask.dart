/// Logo estilo C9digital — quadrado arredondado com gradiente azul→ciano
...
class LogoMinutask extends StatelessWidget {
  ...
  const LogoMinutask({
    super.key,
    this.variante = MinutaskVariante.trabalhador,
    this.tamanho = 40,
            ...
            children: [
              RichText(
                text: TextSpan(
                  ...
                  children: const [
                    TextSpan(text: 'Minu', style: TextStyle(color: Colors.white)),
                    TextSpan(text: 'task', style: TextStyle(color: MinutaskCores.azul)),
                  ],
                ),
              ),
              if (tamanho >= 36)
