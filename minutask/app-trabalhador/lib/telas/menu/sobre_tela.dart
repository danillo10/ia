    ...
    return TelaConteudoMenu(
      ...
      secoes: [
        ...
        SecaoConteudo(
          ...
          texto: ehContratante
              ? 'Você publica pedidos com ponto fixo ou rota, envia fotos de referência, '
                  'negocia valor no chat e acompanha o andamento em tempo real.'
        ...
        SecaoConteudo(
          ...
          texto:
              'Sua localização é usada apenas para encontrar serviços próximos e calcular rotas. '
